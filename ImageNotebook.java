// Modified source code from Dr. Doug Szajda
...
public class ImageNotebook extends JFrame 
  implements ActionListener, MouseListener {
    ...
    static final Dimension buttonSize  = new Dimension(120,35);
    
    // Event handling stuff
    Dimension panelDim = null;

    // THE STUDENT'S DOUBLY LINKED LIST HOLDING IMAGES
    ObjectList<BufferedImage> linkedList = null;
    ...
    public ImageNotebook()
    {
      ...
      linkedList = new ObjectList<BufferedImage>();
    ...
    private BufferedImage selectImage()
    {
      ...
      if (retValue == JFileChooser.APPROVE_OPTION)
      {
        File imageFile = fileChooser.getSelectedFile();
          System.out.println("<" + fileChooser.getName(imageFile) + ">");
